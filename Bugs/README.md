...
| [019](fixed/019-frontend-delete-workspace-non-controle.md) | Frontend : `deleteWorkspace` — suppression finale non contrôlée | frontend | ✅ corrigé |
| [020](fixed/020-frontend-streams-reader-non-annule.md) | Frontend : streams fetch dont le reader n'est jamais annulé | frontend | ✅ corrigé |
...
| [026](fixed/026-mcp-transaction-db-pendant-probe-reseau.md) | MCP : transaction DB tenue pendant l'I/O réseau du probe | mcp | ✅ corrigé |
| [027](fixed/027-mcp-injection-logql-non-echappee.md) | MCP : injection LogQL par interpolation non échappée | mcp | ✅ corrigé |
| [028](fixed/028-mcp-deserialisation-loki-non-validee.md) | MCP : désérialisation non validée de la réponse Loki | mcp | ✅ corrigé |
...
| [036](fixed/036-reconcile-create-task-non-reference-gc.md) | `reconcile` : `create_task` fire-and-forget non référencé (GC) | devpod | ✅ corrigé |
| [037](fixed/037-port-reserved-fuite-sur-echec-synchrone-up.md) | Port `_reserved` jamais libéré sur échec synchrone de `up()` | devpod/exposure | ✅ corrigé |
