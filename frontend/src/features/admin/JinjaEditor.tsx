...
// Palette VS Code Dark+ adaptée Jinja2
...
function highlight(code: string): ReactNode {
  const grammar = Prism.languages['django']
...
export default function JinjaEditor({ value, onChange, minHeight = '180px' }: JinjaEditorProps) {
  return (
    <div
